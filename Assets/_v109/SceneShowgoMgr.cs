...
namespace ShowGo
{
    ...
    public class SceneShowgoMgr: SingletonMono<SceneShowgoMgr>
    {
        ...
        private long currentDJSince;

        public void DJChanged(int oldDJ, int newDJ, long changets)
        {
            currentDJ = newDJ;
            currentDJSince = changets;
        }
        ...
        /// 每N帧创建角色
        /// </summary>
        [BoxGroup("DelayGenerate")]
        [SerializeField] private int perNFrame;
        /// <summary>
        /// 创建时创建多少个,0=不限制
        /// </summary>
        [FormerlySerializedAs("generateNum")]
        [BoxGroup("DelayGenerate")]
        [SerializeField] private int cycWorkSum;
        [BoxGroup("DelayGenerate")]
        ...
        public void EveryoneSpeak(string text)
        {
            ...
            {
                FloatingUiConnector.Instance.SpawnChatBubble(playerkv.Key, text);
            }
        }
